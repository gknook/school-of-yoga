<template>
  ...
  <div
    class="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4 max-w-screen-2xl mx-auto"
  >
    <!-- Third column for additional content -->
    <div
      class="bg-lime-200 pb-4 pt-8 rounded-3xl text-lime-950 flex flex-col justify-center relative"
    >
